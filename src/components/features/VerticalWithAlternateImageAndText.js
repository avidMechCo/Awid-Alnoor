...
import perfume_video from "images/robotics/perfume.mp4"
    ...
    <Container>
      <SingleColumn>
        <HeadingInfoContainer>
          <HeadingTitle>Elctero Mechanic</HeadingTitle>
          <HeadingDescription>
        ...
        <Content>
          {cards.map((card, i) => (
            <Card key={i} reversed={i % 2 === 1}>
              {card.movie_flag ? (
                <video src= {card.videoSrc} type="video/mp4" width="750" height="500" controls/>
                    ) : (
